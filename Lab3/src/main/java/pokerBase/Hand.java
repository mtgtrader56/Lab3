...
public class Hand {
	 ...
	 */
	public static Hand EvaluateHand(Hand h) throws Exception {
		...
		for (Hand hEval : ExplodedHands) {
			...
			HandScore hscores = new HandScore();
			try {
				...
				for (eHandStrength hstr : eHandStrength.values()) {
					...
					Object o = meth.invoke(null, new Object[] { hEval, hscores });
	 ...
	 */
	  ...
	  private static ArrayList<Hand> ExplodeHands(Hand h) {
	    ...
	    public static Hand thebesthand(ArrayList<Hand> Hands) throws Exception
	    {
	    	ArrayList<Hand> AllHands = new ArrayList<Hand>();
	    	
	    		for (Hand h : Hands)
	    		{
	    					AllHands.add(EvaluateHand(h));
				}
	    ...
	    public static ArrayList<Hand> getExplodedHands(Hand h)
	    {
